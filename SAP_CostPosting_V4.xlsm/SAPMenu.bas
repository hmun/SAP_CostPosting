...
Function delSAPCommandbar()
    ...
    For Each aCmdBar In aCmdBars
      If aCmdBar.Name = "SAPRepstPrimCosts" Then
        aCmdBarExists = True
        Exit For
      End If
    Next
...
Attribute addSAPCommandbar.VB_ProcData.VB_Invoke_Func = " \n14"
    ...
    Else
      Set aCmdBar = aCmdBars.Add("SAPRepstPrimCosts", msoBarTop, , True)
        Dim aButton As CommandBarControl
        Set aButton = aCmdBar.Controls.Add(msoControlButton)
        With aButton
            .Style = msoButtonCaption
            .Caption = "Check CO reposting"
            .TooltipText = "Check Cost reposting"
            .OnAction = "SAP_RepstPrimCosts_check"
        End With
        Set aButton = aCmdBar.Controls.Add(msoControlButton)
        With aButton
            .Style = msoButtonCaption
            .Caption = "Post CO reposting"
            .TooltipText = "Post Cost reposting"
            .OnAction = "SAP_RepstPrimCosts_post"
        End With
        Set aButton = aCmdBar.Controls.Add(msoControlButton)
        With aButton
            .BeginGroup = True
